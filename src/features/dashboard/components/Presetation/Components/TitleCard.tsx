...
export const TitleCard: React.FC<TitleCardProps> = ({ title, subTitle }) => {
  return (
    <div className="group duration-500 hover:-skew-x-0 skew-x-6 hover:translate-x-2">
      <div className="group-hover:duration-400 relative rounded-2xl w-72 h-36 bg-app-contrast text-app-white flex flex-col justify-center items-center gap-1 before:-skew-x-12  before:rounded-2xl  before:absolute before:content['']  before:bg-app-contrast/60 before:right-3 before:top-0 before:w-72 before:h-32 before:-z-10">
