...
export const TitleCard: React.FC<TitleCardProps> = ({ title, subTitle }) => {
  return (
    <div className="relative group overflow-hidden border border-app-main/10 bg-white dark:bg-app-secondary p-6 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-500 hover:-translate-y-1">
