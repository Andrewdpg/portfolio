    ...
    <AnimatePresence>
      {isOpen && content && (
        <>
          ...
          {/* Sheet */}
          <motion.div
            className="fixed bottom-0 left-0 right-0 bg-white rounded-t-[28px] z-[600] max-h-[85vh] flex flex-col shadow-2xl"
            initial={{ y: '100%' }}
            animate={{ y: 0 }}
            exit={{ y: '100%' }}
          ...
          >
            ...
            <div
              ...
              onClick={closeDrawer}
            >
              <div className="w-10 h-1 rounded-full bg-app-secondary/15" />
            </div>
            ...
            {content.title && (
              <div className="px-8 pb-4 shrink-0">
                ...
                <h2 className="text-3xl md:text-4xl font-black uppercase tracking-tighter text-app-secondary leading-none">
                  {content.title}
                </h2>
            ...
            {/* Scrollable body */}
            <div className="overflow-y-auto no-scrollbar px-8 pb-10 flex-1">
              {content.body}
            </div>
          </motion.div>
        </>
